...
var config = {
  apiOrigins: {
    production: 'https://afternoon-earth-95866.herokuapp.com/',
...
var showRosterTemplate = __webpack_require__(19);
var showTopSevenTemplate = __webpack_require__(36);
var store = __webpack_require__(2);

var topSeven = [];

var getPlayersSuccess = function getPlayersSuccess(data) {
  store.players = data.players;
  var showRosterHtml = showRosterTemplate({ players: store.players });
  $('.roster').empty();
...
var getPlayersFailure = function getPlayersFailure() {
  $('.roster').text('An error occurred accessing this roster. Please try again.');
};

var postTeamSuccess = function postTeamSuccess(data) {
...
var postTeamFailure = function postTeamFailure() {
  $('#patch-message').text('This player has already been selected. Please choose another player.');
};

var signInTopSevenSuccess = function signInTopSevenSuccess(data) {
  topSeven.length = 0;
...
var signInTopSevenFailure = function signInTopSevenFailure() {
  $('.topseven').text('An error occurred accessing your top seven picks.');
};

var displayTopSeven = function displayTopSeven() {
  $('.year').show();
  $('.roster').show();
  $('.topseven').show();
  var showTopSevenHtml = showTopSevenTemplate({ data: topSeven });
  $('.topseven').text('');
  $('.topseven').append(showTopSevenHtml);
};

var deletePlayerSuccess = function deletePlayerSuccess(data) {
  displayTopSeven();
  $('#patch-message').text('Player Successfully Deleted');
};

var deletePlayerFailure = function deletePlayerFailure() {
  $('.topseven').text('An error occurred deleting this player. Please try again.');
};

var seasonResults = function seasonResults(data) {
  if (data === 2008) {
...
module.exports = {
  ...
  getPlayersFailure: getPlayersFailure,
  signInTopSevenSuccess: signInTopSevenSuccess,
  signInTopSevenFailure: signInTopSevenFailure,
  topSeven: topSeven,
  deletePlayerSuccess: deletePlayerSuccess,
  deletePlayerFailure: deletePlayerFailure,
  postTeamSuccess: postTeamSuccess,
  postTeamFailure: postTeamFailure
};
...
var onGetPlayers = function onGetPlayers(event) {
  event.preventDefault();
  store.year = $(this).data('id');
  api.getPlayers(store.year).then(ui.getPlayersSuccess).then(clickTeam).catch(ui.getPlayersFailure);
};

var signInTopSeven = function signInTopSeven() {
  api.signInTopSevenRoster().then(ui.signInTopSevenSuccess).catch(ui.signInTopSevenFailure);
};

var clickTeam = function clickTeam() {
  $('.roster').off().on('click', 'button', function (event) {
    event.preventDefault();
    var name = $(this).text().trim();
    if (ui.topSeven.some(function (obj) {
      return obj.player.name === name;
    })) {
      ...
      api.postTeamRoster($(this).data('id')).then(ui.postTeamSuccess).catch(ui.postTeamFailure);
    }
  });
};

var onDeletePlayer = function onDeletePlayer() {
  $('.topseven').off().on('click', 'button', function (event) {
    var _this = this;

    event.preventDefault();
    $(this).remove();
    var index = ui.topSeven.findIndex(function (x) {
      return x.id === $(_this).data('id');
    });
    ui.topSeven.splice(index, 1);
    api.deleteEight($(this).data('id')).then(ui.deletePlayerSuccess).catch(ui.deletePlayerFailure);
  });
};
...
var rosterEvents = __webpack_require__(10);
...
var store = __webpack_require__(2);
var rosterUi = __webpack_require__(8);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <ul class='roster-player'>\n    <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.player : stack1)) != null ? stack1.name : stack1), depth0))
    + "</button>\n  </ul>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var getPlayers = function getPlayers(year) {
  return $.ajax({
...
var postTeamRoster = function postTeamRoster(players) {
  return $.ajax({
...
var signInTopSevenRoster = function signInTopSevenRoster() {
  return $.ajax({
    url: config.apiOrigin + '/teams/',
    method: 'GET',
    headers: {
...
var deleteEight = function deleteEight(id) {
  return $.ajax({
...
module.exports = {
  ...
  postTeamRoster: postTeamRoster,
  signInTopSevenRoster: signInTopSevenRoster,
  deleteEight: deleteEight
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onTeamName = function onTeamName(event) {
  event.preventDefault();
  var data = getFormFields(this);
  if (data.teamName) {
    store.teamName = data.teamName;
    api.getTeamName(data.teamName).then(ui.getTeamNameSuccess).catch(ui.getTeamNameFailure);
  } else if (!data.teamName) {
    $('.message-form').text('Please enter a team name into the field');
  }
};

var onGetAllTeams = function onGetAllTeams(event) {
  event.preventDefault();
  api.getTeamName().then(ui.getAllTeamsSuccess).catch(ui.getAllTeamsFailure);
};

var onTeamHistory = function onTeamHistory(event) {
  event.preventDefault();
  ui.teamHistory();
};
...
var getTeamName = function getTeamName(data) {
  return $.ajax({
    url: config.apiOrigin + '/teams/',
    method: 'GET'
  });
...
var rosterEvents = __webpack_require__(10);
var store = __webpack_require__(2);
var showCreatedTeamsTemplate = __webpack_require__(41);
var showMostSelectedTemplate = __webpack_require__(42);

var getTeamNameSuccess = function getTeamNameSuccess(data) {
...
var getTeamNameFailure = function getTeamNameFailure(error) {
  console.log(error);
};

var getAllTeamsSuccess = function getAllTeamsSuccess(data) {
  var allPlayers = [];
  $('#year').hide();
  $('#roster').hide();
  $('#topseven').hide();
  ...
  var dataFilter = function dataFilter(value, index, all) {
    return all.indexOf(value) === index;
  };
  var allUsersArray = data.teams.map(function (a) {
    return a.user.id;
  });
  var uniqueUsersArray = allUsersArray.filter(dataFilter);
  var allTeamNamesArray = data.teams.map(function (a) {
    return a.team_name;
  });
  var uniqueTeamNamesArray = allTeamNamesArray.filter(dataFilter);

  uniqueUsersArray.forEach(function (userID) {
    uniqueTeamNamesArray.forEach(function (teamName) {
      var filterTeam = data.teams.filter(function (item) {
      ...
      if (filterTeam.length >= 7) {
        ...
        var showCreatedTeamsHtml = showCreatedTeamsTemplate({ players: filterTeam });
...
var getAllTeamsFailure = function getAllTeamsFailure(error) {
  console.log(error);
};

var teamHistory = function teamHistory() {
  $('#year').hide();
  $('#roster').hide();
  $('#topseven').hide();
  $('.year').hide();
...
var topSelectedPlayers = function topSelectedPlayers(players) {
  var flattenedPlayers = [].concat.apply([], players);
  var allPlayersArray = flattenedPlayers.map(function (a) {
    return a.player.name;
  });
  var playerOccurrences = {};
  ...
  var playerOccurrencesSorted = Object.keys(playerOccurrences).sort(function (a, b) {
    return playerOccurrences[b] - playerOccurrences[a];
  });
  var mostSelectedPlayers = playerOccurrencesSorted.slice(0, 7);
  var showMostSelectedPlayersHtml = showMostSelectedTemplate({ players: mostSelectedPlayers });
  $('.most-selected-list').append(showMostSelectedPlayersHtml);
};

module.exports = {
  getTeamNameSuccess: getTeamNameSuccess,
  getTeamNameFailure: getTeamNameFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <li class='player-name'>"
    + container.escapeExpression(container.lambda(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.player : stack1)) != null ? stack1.name : stack1), depth0))
    + "</li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<div class='team-list col-md-2'>\n  <h3 class='team-name'>"
    + container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.players : depth0)) != null ? stack1["0"] : stack1)) != null ? stack1.team_name : stack1), depth0))
    + "</h3>\n  <ol>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </ol>\n</div>\n";
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class='team-list'>\n  <h3 class='top-team'>Top-Voted Players</h3>\n  <ul>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.players : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </ul>\n</div>\n";
},"useData":true,"useBlockParams":true});
